...
case $CONFIG_CHOICE in
  1) CONFIG_NAME="TC-Base-DDoS-infec-5RAN-002-stationary" ;;
  2) CONFIG_NAME="TC-Base-DDoS-infec-5RAN-002-slowMoving" ;;
  3) CONFIG_NAME="TC-Base-DDoS-infec-5RAN-002-MixedMoving" ;;
  4) CONFIG_NAME="TC-Base-DDoS-infec-500cbrUEs-5RAN-002-MixedMoving" ;;
  5) CONFIG_NAME="TC-Base-DDoS-infec-500cbrUEsMv-5RAN-002-MixedMoving" ;;
  6) CONFIG_NAME="TC-Base-DDoS-infec-100cbrUEsMv-50VidUEsSt-5RAN-002-MixedMoving" ;;
...
#opp_run -r 0 -c TC-Base-DDoS-infec-5RAN-002 -n $PROJECT_ROOT_DIR/simulations/CaseID/networks/:$PROJECT_ROOT_DIR/src/:$samples_dir/inet4.5/src:$samples_dir/Simu5G-1.2.2/src -l $samples_dir/inet4.5/src/libINET.so -l $samples_dir/Simu5G/src/libsimu5g.so -l $PROJECT_ROOT_DIR/src/libDDoSimu5G.so -u Cmdenv -f  ../Test-cases-001/TC-Base-DDoS-infec-5RAN-002.ini -s --cmdenv-redirect-output=true > "$LOG_FILE" 2>&1
...
opp_run -r $DDOS_FLAG \
  ...
  -u Cmdenv \
  -f ../Test-cases-001/TC-Base-DDoS-infec-5RAN-002.ini \
  -s \
