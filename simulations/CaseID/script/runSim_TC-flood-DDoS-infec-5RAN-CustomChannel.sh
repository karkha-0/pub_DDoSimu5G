...
case $CONFIG_CHOICE in
  1) CONFIG_NAME="TC-flood-DDoS-infec-5RAN-002-stationary-customChannel" ;;
  2) CONFIG_NAME="TC-flood-DDoS-infec-5RAN-002-slowMoving-customChannel" ;;
  3) CONFIG_NAME="TC-flood-DDoS-infec-5RAN-002-MixedMoving-customChannel" ;;
  4) CONFIG_NAME="TC-flood-DDoS-infec-500cbrUEsSt-5RAN-002-MixedMoving-customChannel" ;;
  5) CONFIG_NAME="TC-flood-DDoS-infec-500cbrUEsMv-5RAN-002-MixedMoving-customChannel" ;;
...
LOG_FILE="$LOG_DIR/CustomChannel-${CONFIG_NAME}_simulation_DDOS_FLAG_${DDOS_FLAG}_${SIMTIME}_${DATE_TIME}.log"
